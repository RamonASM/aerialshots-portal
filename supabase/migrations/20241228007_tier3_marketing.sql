...
-- QR Codes
DROP POLICY IF EXISTS "Staff can manage all QR codes" ON qr_codes;
DROP POLICY IF EXISTS "Staff can manage all QR codes" ON qr_codes;
...
DROP POLICY IF EXISTS "Agents can manage own QR codes" ON qr_codes;
DROP POLICY IF EXISTS "Agents can manage own QR codes" ON qr_codes;
...
DROP POLICY IF EXISTS "Anyone can record scans" ON qr_code_scans;
DROP POLICY IF EXISTS "Anyone can record scans" ON qr_code_scans;
CREATE POLICY "Anyone can record scans" ON qr_code_scans
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Staff can view scans" ON qr_code_scans;
DROP POLICY IF EXISTS "Staff can view scans" ON qr_code_scans;
...
DROP POLICY IF EXISTS "Agents can view own QR scans" ON qr_code_scans;
DROP POLICY IF EXISTS "Agents can view own QR scans" ON qr_code_scans;
...
-- Social Templates
DROP POLICY IF EXISTS "Anyone can view active templates" ON social_templates;
DROP POLICY IF EXISTS "Anyone can view active templates" ON social_templates;
...
DROP POLICY IF EXISTS "Staff can manage all templates" ON social_templates;
DROP POLICY IF EXISTS "Staff can manage all templates" ON social_templates;
...
DROP POLICY IF EXISTS "Agents can manage own templates" ON social_templates;
DROP POLICY IF EXISTS "Agents can manage own templates" ON social_templates;
...
-- Marketing Assets
DROP POLICY IF EXISTS "Staff can manage all assets" ON marketing_assets;
DROP POLICY IF EXISTS "Staff can manage all assets" ON marketing_assets;
...
DROP POLICY IF EXISTS "Agents can manage own assets" ON marketing_assets;
DROP POLICY IF EXISTS "Agents can manage own assets" ON marketing_assets;
...
-- Portfolio Items
DROP POLICY IF EXISTS "Anyone can view visible portfolio items" ON portfolio_items;
DROP POLICY IF EXISTS "Anyone can view visible portfolio items" ON portfolio_items;
CREATE POLICY "Anyone can view visible portfolio items" ON portfolio_items
  FOR SELECT USING (is_visible = true);

DROP POLICY IF EXISTS "Staff can manage all portfolio items" ON portfolio_items;
DROP POLICY IF EXISTS "Staff can manage all portfolio items" ON portfolio_items;
...
DROP POLICY IF EXISTS "Agents can manage own portfolio" ON portfolio_items;
DROP POLICY IF EXISTS "Agents can manage own portfolio" ON portfolio_items;
