...
CREATE INDEX idx_listing_campaigns_listing ON listing_campaigns(listing_id);
CREATE INDEX idx_listing_campaigns_agent ON listing_campaigns(agent_id);
CREATE INDEX idx_listing_campaigns_status ON listing_campaigns(status);
...
-- =====================
CREATE TABLE listing_carousels (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_listing_carousels_campaign ON listing_carousels(campaign_id);
CREATE INDEX idx_listing_carousels_type ON listing_carousels(carousel_type);

-- =====================
-- LISTING BLOG POSTS
-- SEO blog posts generated from campaigns
-- =====================
CREATE TABLE listing_blog_posts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  campaign_id UUID REFERENCES listing_campaigns(id) ON DELETE CASCADE NOT NULL,
...
CREATE INDEX idx_listing_blog_posts_campaign ON listing_blog_posts(campaign_id);
CREATE INDEX idx_listing_blog_posts_slug ON listing_blog_posts(slug);
...
CREATE UNIQUE INDEX idx_instagram_connections_agent ON instagram_connections(agent_id);
CREATE INDEX idx_instagram_connections_ig_user ON instagram_connections(instagram_user_id);
...
CREATE INDEX idx_ig_scheduled_agent ON instagram_scheduled_posts(agent_id);
CREATE INDEX idx_ig_scheduled_status ON instagram_scheduled_posts(status);
CREATE INDEX idx_ig_scheduled_for ON instagram_scheduled_posts(scheduled_for);
...
-- =====================
CREATE TABLE instagram_embed_cache (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  agent_id UUID REFERENCES agents(id) ON DELETE CASCADE NOT NULL,
...
CREATE INDEX idx_ig_embed_agent ON instagram_embed_cache(agent_id);
CREATE INDEX idx_ig_embed_url ON instagram_embed_cache(instagram_url);
CREATE INDEX idx_ig_embed_expires ON instagram_embed_cache(expires_at);

-- =====================
-- CAROUSEL TYPES REFERENCE
-- Predefined carousel types and their prompts
-- =====================
CREATE TABLE carousel_types (
