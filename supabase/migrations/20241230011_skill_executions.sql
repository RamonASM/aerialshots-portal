...
DROP POLICY IF EXISTS "Staff can view skill executions" ON skill_executions;
DROP POLICY IF EXISTS "Staff can view skill executions" ON skill_executions;
...
DROP POLICY IF EXISTS "Staff can insert skill executions" ON skill_executions;
DROP POLICY IF EXISTS "Staff can insert skill executions" ON skill_executions;
...
DROP POLICY IF EXISTS "Staff can update skill executions" ON skill_executions;
DROP POLICY IF EXISTS "Staff can update skill executions" ON skill_executions;
...
DROP POLICY IF EXISTS "Service role full access to skill executions" ON skill_executions;
DROP POLICY IF EXISTS "Service role full access to skill executions" ON skill_executions;
...
DROP POLICY IF EXISTS "Anyone can view listing skill outputs" ON listing_skill_outputs;
DROP POLICY IF EXISTS "Anyone can view listing skill outputs" ON listing_skill_outputs;
...
DROP POLICY IF EXISTS "Staff can insert listing skill outputs" ON listing_skill_outputs;
DROP POLICY IF EXISTS "Staff can insert listing skill outputs" ON listing_skill_outputs;
...
DROP POLICY IF EXISTS "Staff can update listing skill outputs" ON listing_skill_outputs;
DROP POLICY IF EXISTS "Staff can update listing skill outputs" ON listing_skill_outputs;
...
-- Service role can do anything (for agents/workflows)
DROP POLICY IF EXISTS "Service role full access to listing skill outputs" ON listing_skill_outputs;
DROP POLICY IF EXISTS "Service role full access to listing skill outputs" ON listing_skill_outputs;
