...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE photographer_assignments ADD COLUMN IF NOT EXISTS location_lat DECIMAL(10,7);
    ALTER TABLE photographer_assignments ADD COLUMN IF NOT EXISTS location_lng DECIMAL(10,7);
  END IF;
END $$;
