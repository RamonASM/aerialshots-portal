...
DROP POLICY IF EXISTS "agent_assets_public_read" ON storage;
...
DROP POLICY IF EXISTS "agent_assets_auth_insert" ON storage;
...
DROP POLICY IF EXISTS "agent_assets_auth_update" ON storage;
...
DROP POLICY IF EXISTS "agent_assets_auth_delete" ON storage;
...
DROP POLICY IF EXISTS "agent_assets_service_all" ON storage;
