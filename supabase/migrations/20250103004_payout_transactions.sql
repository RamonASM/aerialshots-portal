...
DROP POLICY IF EXISTS "Service role full access to payout idempotency" ON payout_idempotency;
CREATE POLICY "Service role full access to payout idempotency" ON payout_idempotency
FOR ALL
TO service_role
USING (true)
WITH CHECK (true);
