...
-- =====================
CREATE TABLE IF NOT EXISTS storywork_users (
...
CREATE INDEX IF NOT EXISTS idx_storywork_users_clerk_id ON storywork_users(clerk_id);
CREATE INDEX IF NOT EXISTS idx_storywork_users_email ON storywork_users(email);
CREATE INDEX IF NOT EXISTS idx_storywork_users_asm_agent_id ON storywork_users(asm_agent_id);

DROP TRIGGER IF EXISTS storywork_users_updated_at ON storywork_users;
...
-- =====================
CREATE TABLE IF NOT EXISTS storywork_brand_kits (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_storywork_brand_kits_user_id ON storywork_brand_kits(user_id);

DROP TRIGGER IF EXISTS storywork_brand_kits_updated_at ON storywork_brand_kits;
...
-- STORYWORK STORIES
-- =====================
CREATE TABLE IF NOT EXISTS storywork_stories (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES storywork_users(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_storywork_stories_user_id ON storywork_stories(user_id);
CREATE INDEX IF NOT EXISTS idx_storywork_stories_status ON storywork_stories(status);
CREATE INDEX IF NOT EXISTS idx_storywork_stories_created_at ON storywork_stories(created_at);

DROP TRIGGER IF EXISTS storywork_stories_updated_at ON storywork_stories;
...
-- =====================
CREATE TABLE IF NOT EXISTS storywork_credit_transactions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_storywork_credit_txns_user_id ON storywork_credit_transactions(user_id);
CREATE INDEX IF NOT EXISTS idx_storywork_credit_txns_created_at ON storywork_credit_transactions(created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_unified_users_email ON unified_users(email);
CREATE INDEX IF NOT EXISTS idx_unified_users_asm_agent_id ON unified_users(asm_agent_id);
CREATE INDEX IF NOT EXISTS idx_unified_users_storywork_user_id ON unified_users(storywork_user_id);
...
-- =====================
CREATE TABLE IF NOT EXISTS unified_credit_transactions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_unified_credit_txns_user_id ON unified_credit_transactions(unified_user_id);
CREATE INDEX IF NOT EXISTS idx_unified_credit_txns_type ON unified_credit_transactions(transaction_type);
CREATE INDEX IF NOT EXISTS idx_unified_credit_txns_created_at ON unified_credit_transactions(created_at);
CREATE INDEX IF NOT EXISTS idx_unified_credit_txns_idempotency ON unified_credit_transactions(idempotency_key);
...
CREATE INDEX IF NOT EXISTS idx_credit_reservations_user_id ON credit_reservations(unified_user_id);
...
DROP POLICY IF EXISTS "Service role access for storywork_users" ON storywork_users;
DROP POLICY IF EXISTS "Service role access for storywork_brand_kits" ON storywork_brand_kits;
DROP POLICY IF EXISTS "Service role access for storywork_stories" ON storywork_stories;
DROP POLICY IF EXISTS "Service role access for storywork_credit_transactions" ON storywork_credit_transactions;
DROP POLICY IF EXISTS "Service role access for unified_users" ON unified_users;
DROP POLICY IF EXISTS "Service role access for unified_credit_transactions" ON unified_credit_transactions;
DROP POLICY IF EXISTS "Service role access for credit_reservations" ON credit_reservations;
