...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE staff ADD COLUMN team_role team_role DEFAULT 'photographer';
  END IF;
END $$;
...
INSERT INTO invoice_templates (name, description, is_default, payment_terms, styling) VALUES
(
  'Standard Invoice',
  'Default invoice template with ASM branding',
  TRUE,
  'Payment due within 7 days of invoice date. Late payments may incur a 1.5% monthly fee.',
  '{
    "primaryColor": "#3b82f6",
    "accentColor": "#1e40af",
