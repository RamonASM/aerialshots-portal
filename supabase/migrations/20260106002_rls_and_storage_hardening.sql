...
DROP POLICY IF EXISTS "virtual_staging_public_read" ON storage;
...
DROP POLICY IF EXISTS "virtual_staging_auth_insert" ON storage;
...
DROP POLICY IF EXISTS "virtual_staging_auth_update" ON storage;
...
DROP POLICY IF EXISTS "virtual_staging_auth_delete" ON storage;
...
DROP POLICY IF EXISTS "media_assets_public_read" ON storage;
...
DROP POLICY IF EXISTS "media_assets_auth_insert" ON storage;
...
DROP POLICY IF EXISTS "media_assets_auth_update" ON storage;
...
DROP POLICY IF EXISTS "media_assets_auth_delete" ON storage;
...
DROP POLICY IF EXISTS "render_cache_public_read" ON storage;
...
DROP POLICY IF EXISTS "render_cache_auth_insert" ON storage;
...
DROP POLICY IF EXISTS "render_cache_auth_update" ON storage;
...
DROP POLICY IF EXISTS "render_cache_auth_delete" ON storage;
...
DROP POLICY IF EXISTS "Reference files staff access" ON storage;
DROP POLICY IF EXISTS "Reference files staff access" ON storage;
