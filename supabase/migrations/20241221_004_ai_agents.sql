...
CREATE INDEX idx_ai_agent_executions_agent_slug ON ai_agent_executions(agent_slug);
CREATE INDEX idx_ai_agent_executions_status ON ai_agent_executions(status);
CREATE INDEX idx_ai_agent_executions_listing_id ON ai_agent_executions(listing_id);
CREATE INDEX idx_ai_agent_executions_created_at ON ai_agent_executions(created_at DESC);
CREATE INDEX idx_ai_agent_executions_trigger_source ON ai_agent_executions(trigger_source);
...
CREATE INDEX idx_ai_agent_workflows_trigger_event ON ai_agent_workflows(trigger_event);
CREATE INDEX idx_ai_agent_workflows_status ON ai_agent_workflows(status);
CREATE INDEX idx_ai_agent_workflows_listing_id ON ai_agent_workflows(listing_id);
...
CREATE POLICY "Service role has full access to ai_agent_executions"
  ON ai_agent_executions FOR ALL
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Service role has full access to ai_agent_workflows"
