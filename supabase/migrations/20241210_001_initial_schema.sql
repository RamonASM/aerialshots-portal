...
CREATE INDEX idx_listings_aryeo_listing_id ON listings(aryeo_listing_id);
CREATE INDEX idx_listings_status ON listings(status);
CREATE INDEX idx_listings_ops_status ON listings(ops_status);
...
CREATE INDEX idx_media_assets_listing_id ON media_assets(listing_id);
...
CREATE INDEX idx_curated_items_location ON curated_items(lat, lng);
CREATE INDEX idx_curated_items_category ON curated_items(category);

-- =====================
-- AGENT_TIPS
-- =====================
CREATE TABLE agent_tips (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_agent_tips_agent_id ON agent_tips(agent_id);
CREATE INDEX idx_agent_tips_listing_id ON agent_tips(listing_id);
...
CREATE INDEX idx_redemptions_agent_id ON redemptions(agent_id);
...
CREATE INDEX idx_ai_tool_usage_agent_id ON ai_tool_usage(agent_id);
CREATE INDEX idx_ai_tool_usage_tool_type ON ai_tool_usage(tool_type);
...
CREATE INDEX idx_webhook_events_aryeo_event_id ON webhook_events(aryeo_event_id);
...
CREATE INDEX idx_job_events_listing_id ON job_events(listing_id);
