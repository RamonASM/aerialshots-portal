...
CREATE INDEX idx_processing_jobs_listing_id ON processing_jobs(listing_id);
CREATE INDEX idx_processing_jobs_status ON processing_jobs(status);
CREATE INDEX idx_processing_jobs_founddr_job_id ON processing_jobs(founddr_job_id);
...
CREATE INDEX idx_inpainting_jobs_media_asset_id ON inpainting_jobs(media_asset_id);
CREATE INDEX idx_inpainting_jobs_status ON inpainting_jobs(status);
CREATE INDEX idx_inpainting_jobs_created_by ON inpainting_jobs(created_by);

-- =====================
-- LIGHTROOM_EXPORTS (bridge for complex edits)
-- =====================
CREATE TABLE lightroom_exports (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_lightroom_exports_listing_id ON lightroom_exports(listing_id);
CREATE INDEX idx_lightroom_exports_status ON lightroom_exports(status);
CREATE INDEX idx_lightroom_exports_exported_by ON lightroom_exports(exported_by);
...
CREATE INDEX idx_qc_sessions_staff_id ON qc_sessions(staff_id);
CREATE INDEX idx_qc_sessions_listing_id ON qc_sessions(listing_id);
CREATE INDEX idx_qc_sessions_started_at ON qc_sessions(started_at DESC);
...
CREATE INDEX idx_delivery_notifications_listing_id ON delivery_notifications(listing_id);
CREATE INDEX idx_delivery_notifications_agent_id ON delivery_notifications(agent_id);
CREATE INDEX idx_delivery_notifications_status ON delivery_notifications(status);
CREATE INDEX idx_delivery_notifications_scheduled ON delivery_notifications(scheduled_for)
