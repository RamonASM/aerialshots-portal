...
CREATE POLICY "Staff can manage all edit requests"
...
CREATE POLICY "Agents can view their edit requests"
...
CREATE POLICY "Agents can create edit requests"
...
CREATE POLICY "Staff can manage edit request comments"
ON edit_request_comments FOR ALL
TO authenticated
USING (
  EXISTS (
    SELECT 1 FROM staff
...
ON edit_request_comments FOR SELECT
TO authenticated
USING (
  is_internal = false
...
CREATE POLICY "Staff can manage service catalog"
