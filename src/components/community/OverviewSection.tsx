...
export function OverviewSection({
  ...
  return (
    <section>
        ...
        <div className="mt-6 space-y-4">
          {overviewContent.blocks.map((block, index) => {
            if (block.type === 'heading') {
              return (
                <h3 key={index} className="text-xl font-semibold text-neutral-900">
                  {block.content}
                </h3>
              )
            }
        ...
        <div className="mt-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {overviewContent.highlights.map((highlight, index) => (
              <div
                key={index}
                className="flex items-center gap-2 rounded-lg bg-blue-50 p-3 text-blue-800"
              >
      ...
      {/* Quick Facts Grid */}
      {quickFacts && (
        <div className="mt-8 grid gap-4 rounded-xl bg-neutral-50 p-6 sm:grid-cols-2 lg:grid-cols-3">
          {quickFacts.median_income && (
            <div>
              <div className="text-sm text-neutral-500">Median Income</div>
          ...
          {quickFacts.avg_commute && (
            <div>
              <div className="text-sm text-neutral-500">Avg Commute</div>
              <div className="text-lg font-semibold text-neutral-900">
          ...
          {quickFacts.zip_codes && quickFacts.zip_codes.length > 0 && (
            <div>
              <div className="text-sm text-neutral-500">ZIP Codes</div>
              <div className="text-lg font-semibold text-neutral-900">
          ...
          {quickFacts.nearby_cities && quickFacts.nearby_cities.length > 0 && (
            <div className="sm:col-span-2 lg:col-span-3">
              <div className="text-sm text-neutral-500">Nearby Cities</div>
              <div className="text-lg font-semibold text-neutral-900">
