      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-[22px] font-semibold text-white">Content Curation</h1>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] text-[#a1a1a6]">{info.title}</span>
                  </div>
                  <p className="mt-2 text-[28px] font-semibold text-white">{count}</p>
                </div>
              )
            })}
          </div>
          ...
          {items && items.length > 0 ? (
                        ...
                        <div>
                          ...
                          {item.source_url && (
                            <a
                              ...
                              className="mt-2 inline-flex items-center gap-1 text-[13px] text-[#0077ff] hover:underline"
                            >
                              View Source
            ...
            <div className="rounded-xl border border-white/[0.08] bg-[#1c1c1e] p-12 text-center">
              <MapPin className="mx-auto h-12 w-12 text-[#636366]" />
              <h3 className="mt-4 font-semibold text-white">No curated items</h3>
